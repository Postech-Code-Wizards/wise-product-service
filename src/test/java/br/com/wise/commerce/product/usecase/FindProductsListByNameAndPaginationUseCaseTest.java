...
class FindProductsListByNameAndPaginationUseCaseTest {

    @Mock
    ProductGateway productGateway;

    @InjectMocks
    FindProductsListByNameAndPaginationUseCase findProductsListByNameAndPaginationUseCase;
    ...
    void shouldReturnAListOfProductsWithPagination() {
        ...
        when(productGateway.findProductsListByNameAndPagination(name, page, size)).thenReturn(List.of(expectedProduct));

        List<Product> result = findProductsListByNameAndPaginationUseCase.execute(name, page, size);
